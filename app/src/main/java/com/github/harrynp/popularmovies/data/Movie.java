...
public class Movie implements Parcelable {
    ...
    public Movie(String name, int id, String posterUrl, String backdropUrl, String movieOverview, Double movieRating, String movieReleaseDate, int movieVoteCount){
        movieName = name;
        movieId = id;
